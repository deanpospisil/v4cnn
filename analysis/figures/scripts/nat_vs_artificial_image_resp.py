...
nat_resp = xr.open_dataset(top_dir + 'data/responses/alex_net_nat_image_dist2000.nc')['r'].load()
nat_resp = nat_resp
nat_resp = nat_resp[:370,]
...
stacked_hist_layers(nat, logx=False, logy=True, xlim=None, maxlim=False, bins=100)
stacked_hist_layers(apc, logx=False, logy=True, xlim=None, maxlim=False, bins=100)
