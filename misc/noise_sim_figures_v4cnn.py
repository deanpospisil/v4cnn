...
v4_resp_ti = v4_resp_ti[cat_true]
...
#%%
v4_ti = []
for i, a_v4_resp in enumerate(v4_resp_ti):
    x = a_v4_resp.dropna('x', how='all').dropna('shapes', how='all')
...
plt.scatter(v4_ti, (1-np.array(ti_m_cor_list)), color='k')
...
plt.savefig(top_dir + 'analysis/figures/images/v4cnn_cur/'+str('4_')+ 
            'TI_noise_adj_just_vex.pdf', bbox_inches='tight')
