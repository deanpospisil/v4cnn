...
plt.savefig(top_dir + 'analysis/figures/images/apc_correlation_by_layer.png')
...
plt.suptitle('Translation Invariance')
plt.savefig(top_dir + 'analysis/figures/images/translation_invariance_by_layer.png')
plt.savefig(top_dir + 'analysis/figures/images/translation_invariance_by_layer.eps')
...
plt.suptitle('APC correlation')
plt.savefig(top_dir + 'analysis/figures/images/apc_correlation_by_layer.png')
plt.savefig(top_dir + 'analysis/figures/images/apc_correlation_by_layer.eps')



#v4ness: 1 - distance from [1,1], perfect V4
plt.figure()
v4ness =  ((1-apc)**2 + (1-ti)**2)**0.5
stacked_hist_layers(v4ness[both.k<40], logx=False, logy=False, xlim=[0,1], bins=100) 
plt.suptitle('distance from [1,1], perfect V4')
plt.savefig(top_dir + 'analysis/figures/images/v4ness_by_layer.png')
plt.savefig(top_dir + 'analysis/figures/images/v4ness_by_layer.eps')
