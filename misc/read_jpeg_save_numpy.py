...
img_dir = top_dir + '/images/baseimgs/natural/'
extension = 'JPEG'
...
rolled = np.array([ np.array([img[2], img[1], img[0]]) for img in imgs]) # need to swap from RGB to BGR

rolled = rolled - rolled.mean(axis=(0,2,3)).reshape(1,3,1,1)
